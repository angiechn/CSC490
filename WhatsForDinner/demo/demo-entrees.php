...
require "common.php";
?>
<?php // query to fetch entrees
$entreeSQL = "SELECT whatsdinner.recipe.recipeID, whatsdinner.recipe.recipeName 
...
$entreeStmt= $connection->prepare($entreeSQL); 
$entreeStmt->execute();
$entreeResult = $entreeStmt->fetchAll();
?>
	...
	<div class="result-container">
		<div class="container">
				<?php // output results for match case
					if ($entreeResult && $entreeStmt->rowCount() > 0 && !isset($_POST['submitMatchCase'])) { ?>
						<div class="row">
								<?php foreach ($entreeResult as $row) { 
