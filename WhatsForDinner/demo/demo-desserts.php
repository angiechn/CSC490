...
$dessertSQL = "SELECT whatsdinner.recipe.recipeID, whatsdinner.recipe.recipeName 
...
$dessertStmt= $connection->prepare($dessertSQL); 
$dessertStmt->execute();
$dessertResult = $dessertStmt->fetchAll();
?>
	...
	<div class="result-container">
		<div class="container">
				<?php // output results for match case
					if ($dessertResult && $dessertStmt->rowCount() > 0 && !isset($_POST['submitMatchCase'])) { ?>
						<div class="row">
								<?php foreach ($dessertResult as $row) { 
