			...
			<div class="row">
				<div class="col-lg-12">
					<div class="text-sm-left">
						<p>To select multiple, hold CTRL while clicking.</p>
					</div>
					<!-- Submit Multi Search -->
					<div class="dropdown">
						<form method="post">
					...
					<div class="row">
						<?php foreach ($MultiSearchResult as $row) {
							...
							<div class="col-lg-11">
								<img src="../images/<?php echo escape($row["recipeID"]); ?>.jpg" class="result-image" alt="Image">
								<h1><a href="demo-recipe.php?recipeID=<?php echo escape($row["recipeID"]); ?>"> <?php echo escape($row["recipeName"]); ?></a></h1>
								<p class="em"> <?php foreach ($MatchIngResult as $tuple) {
																	echo escape($tuple["rawName"]) . ", ";
																} ?> </p>
								<p> <?php foreach ($OtherIngResult as $tuple) {
																	echo escape($tuple["rawName"]) . ", ";
																} ?> </p>
							</div>
						<?php } ?>
